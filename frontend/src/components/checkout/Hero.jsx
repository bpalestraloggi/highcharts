...
export default function Hero({ onCta }) {
    return (
        <section id="top" className="relative isolate overflow-hidden">
            <div className="mx-auto max-w-7xl px-5 pt-10 pb-16 sm:px-8 sm:pt-20 sm:pb-24 lg:px-12 lg:pt-32 lg:pb-32">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-12">
                    ...
                    >
                        ...
                        <h1 className="mt-6 font-serif text-[2.5rem] leading-[1.02] tracking-tight sm:mt-8 sm:text-6xl lg:text-[5.25rem]">
                            Um checkout
                            <br />
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-3 sm:mt-10">
                            <button
                                ...
                                className="group inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 active:scale-[0.98] sm:px-7 sm:py-3.5"
                            >
                                Iniciar simulação
                            ...
                            <a
                                ...
                                className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-6 py-3 text-sm font-semibold text-foreground transition-all hover:border-foreground/30 sm:px-7 sm:py-3.5"
                            >
                                Ver antes & depois
                            </a>
                        </div>

                        <div className="mt-10 grid grid-cols-3 gap-4 border-t border-border/70 pt-7 sm:mt-14 sm:gap-6 sm:pt-8">
                            {stat.map((s) => (
                                <div key={s.label}>
                                    <div className="font-serif text-2xl tracking-tight sm:text-3xl lg:text-4xl">
                                        {s.value}
                                    </div>
                                    <div className="mt-1 text-[10px] uppercase leading-tight tracking-[0.15em] text-muted-foreground sm:text-xs sm:tracking-[0.18em]">
                                        {s.label}
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="relative">
                            ...
                            <div className="glass-card relative rounded-3xl p-6 sm:p-8">
                                ...
                                <div className="mt-8">
                                    ...
                                    <div className="num-display mt-2 text-5xl sm:text-6xl">
                                        R$ 909
